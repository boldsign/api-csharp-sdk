...
namespace BoldSign.Api
{
    ...
    public class UserClient : IUserClient
    {
        ...
        /// <param name="userId">The userIds.</param>
        ...
        public ApiResponse<object> ChangeTeamWithHttpInfo(string userId, ChangeTeam changeTeam)
        {
            ...
            var localVarPath = "/v1-beta/users/changeTeam";
            var localVarQueryParams = new List<KeyValuePair<string, string>>();
            var localVarHeaderParams = new Dictionary<string, string>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<string, string>();
            var localVarFileParams = new Dictionary<string, List<IDocumentFile>>();
...
#pragma warning restore SA1118 // Parameter should not span multiple lines
        ...
        public async Task<ApiResponse<object>> UpdateUserMetaDataAsyncWithHttpInfo(UpdateUserMetaData updateUserMetaData)
        {
            ...
            var localVarPath = "/v1-beta/users/updateMetaData";
            var localVarQueryParams = new List<KeyValuePair<string, string>>();
            var localVarHeaderParams = new Dictionary<string, string>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<string, string>();
            var localVarFileParams = new Dictionary<string, List<IDocumentFile>>();
        ...
        {
            this.UpdateUserWithHttpInfo(updateUserMetaData);
        }

        /// <inheritdoc/>
        public ApiResponse<object> UpdateUserWithHttpInfo(UpdateUserMetaData updateUserMetaData)
        {
            if (updateUserMetaData == null)
            {
                throw new ArgumentNullException(nameof(updateUserMetaData));
