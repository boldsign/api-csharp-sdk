namespace BoldSign.Api
{
    ...
    public interface ITemplateClient : IApiAccessor
    {
        ...
        TemplateRecords ListTemplates(int page, int? pageSize = default);
        ...
        ApiResponse<TemplateRecords> ListTemplatesWithHttpInfo(int page, int? pageSize = default);
        ...
        Task<TemplateRecords> ListTemplatesAsync(int page, int? pageSize = default);
        ...
        Task<ApiResponse<TemplateRecords>> ListTemplatesAsyncWithHttpInfo(int page, int? pageSize = default);
